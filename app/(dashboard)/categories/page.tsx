...
import { Plus, MoreHorizontal, Check, Trash2, X, Package } from 'lucide-react'
...
export default function CategoriesPage() {
  ...
  // Body scroll lock
  useEffect(() => {
    const anyOpen = createOpen || !!actionSheetCat || !!confirmDeleteCat
    document.body.style.overflow = anyOpen ? 'hidden' : ''
    return () => { document.body.style.overflow = '' }
  }, [createOpen, actionSheetCat, confirmDeleteCat])
